      ...
      <div className="container max-w-[1100px] mx-auto">
        ...
        <div className="prob-grid grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mt-[52px] items-start">
          ...
          <div className="prob-list flex flex-col gap-3.5 reveal opacity-1 translate-y-7 transition-all duration-700 ease-out">
            ...
            <div className="prob-item flex items-start gap-3.5 p-[17px_20px] bg-[rgba(255,60,60,0.04)] border border-[rgba(255,80,80,0.12)] rounded-[13px] transition-all duration-200 hover:bg-[rgba(255,60,60,0.07)] hover:border-[rgba(255,80,80,0.22)] hover:translate-x-1">
