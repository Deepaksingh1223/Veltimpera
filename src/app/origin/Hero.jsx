  ...
  return (
    <section className="hero min-h-screen flex flex-col items-center justify-center text-center pt-[120px] pb-20 px-4 md:px-6 lg:px-10 relative overflow-hidden max-sm:pt-[90px] max-sm:pb-[55px]">
      ...
      <div className="hero-content relative z-[2] w-full max-w-[1100px] mx-auto px-4 sm:px-6">
        ...
        {/* Badge */}
        <div className="hero-badge inline-flex items-center gap-2 py-1.5 px-4 bg-[rgba(13,107,63,0.2)] border border-[rgba(34,201,122,0.25)] rounded-full text-[11px] sm:text-xs font-semibold text-[#22c97a] tracking-[0.08em] uppercase mb-6 sm:mb-7">
        ...
        <div className="hero-ctas flex flex-col sm:flex-row gap-3.5 justify-center mb-12 sm:mb-16">
          ...
          <button className="btn-hg py-[14px] sm:py-[15px] px-[30px] sm:px-[34px] bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.12)] text-white text-[14px] sm:text-[15px] font-semibold rounded-xl cursor-pointer font-['Inter',sans-serif] transition-all duration-200 backdrop-blur-[8px] hover:bg-[rgba(255,255,255,0.08)] hover:-translate-y-0.5">
            Explore Ecosystem →
          </button>
        </div>
        ...
        <div className="chips flex gap-1.5 sm:gap-2 flex-wrap justify-center mt-4 mb-8 px-2">
          <div className="chip py-1 px-2 sm:px-3 bg-[rgba(34,201,122,0.08)] border border-[rgba(34,201,122,0.2)] rounded-full text-[10px] sm:text-[11px] font-semibold text-[#22c97a] flex items-center gap-1">
            👁️ Views
          </div>
          <div className="chip py-1 px-2 sm:px-3 bg-[rgba(34,201,122,0.08)] border border-[rgba(34,201,122,0.2)] rounded-full text-[10px] sm:text-[11px] font-semibold text-[#22c97a] flex items-center gap-1">
            ❤️ Likes
