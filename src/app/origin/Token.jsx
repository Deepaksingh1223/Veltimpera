  ...
  return (
    <section style={{ background: "var(--bk2)", textAlign: "center" }} className="bg-[#0b120d] text-center py-24 px-4 sm:px-6 lg:px-10 relative max-sm:py-[60px]" id="token">
      <div className="container max-w-[1100px] mx-auto">
        ...
        <div style={{justifyContent:"center"}} className="eyebrow text-[11px] font-bold tracking-[0.15em] uppercase text-[#22c97a] mb-3.5 flex items-center gap-2.5 before:content-[''] before:block before:w-[22px] before:h-px before:bg-[#22c97a] justify-center">
        ...
        <div className="token-vis relative w-[250px] h-[250px] flex items-center justify-center mx-auto my-[52px]">
          <div className="t-orbit absolute rounded-full border-dashed border-[rgba(34,201,122,0.15)] w-[248px] h-[248px] top-0 left-0 animate-[orb_10s_linear_infinite]">
            <div className="orb-dot absolute w-2 h-2 rounded-full bg-[#39ff98] shadow-[0_0_9px_#39ff98] -top-1 left-[calc(50%-4.5px)]"></div>
          </div>
          <div className="t-orbit absolute rounded-full border-dashed border-[rgba(34,201,122,0.15)] w-[190px] h-[190px] top-[29px] left-[29px] animate-[orb_16s_linear_infinite_reverse] opacity-50">
        ...
        <div className="tok-feats grid grid-cols-1 md:grid-cols-3 gap-[18px] text-left reveal opacity-1 translate-y-7 transition-all duration-700 ease-out">
          ...
          <div className="tf p-[22px] bg-[rgba(15,26,18,0.85)] border-[rgba(34,201,122,0.15)] rounded-2xl transition-all duration-200 hover:border-[rgba(34,201,122,0.3)] hover:-translate-y-1">
